...
data_riboswitch_transcriptional[-(1:4)] <- + sapply(data_riboswitch_transcriptional[-(1:4)], as.logical)
data_riboswitch_translational[-(1:4)] <- + sapply(data_riboswitch_translational[-(1:4)], as.logical)
...
ggplot(df_riboswitch_group,
  ...
  scale_size_continuous(range = c(3,13), breaks = seq(0.2,1, 0.2) )
dev.off()
